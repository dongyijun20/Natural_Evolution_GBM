...
patient=sys.argv[1]
doublet_rate=float(sys.argv[2]) #0.08, the expected fraction of transcriptomes that are doublets, typically 0.05-0.1. Results are not particularly sensitive to this parameter.
